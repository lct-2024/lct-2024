    ...
    return (
        <div className='container'>
            <div className={style.main}>
                ...
                <button className={style.btn}>Смотреть все проекты <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div className={style.smallBlock}>
                        ...
                        <div>
                            <p>№238 из 479 в рейтинге работодателей hh</p>
                        </div>
                    </div>
                    <div className={style.smallBlock}>
                        <div>
                ...
                <button className={style.btn}>Награды и достижения <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.00195 12H19.002M19.002 12L12.002 5M19.002 12L12.002 19" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                </button>
