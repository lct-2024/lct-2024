        ...
        <div className={t ? style.main : style.main2}>
            <div className={style.sect}>
                ...
                {link == "https://www.youtube.com/watch?v=fI4htZchBz0" ?
                    <iframe width="400" className={style.video} height="400" src="https://www.youtube.com/embed/fI4htZchBz0?si=8GaEWZP1_nu65e8O" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    :
